...
import CreateMetaTagging from "./CreateMetaTaggingPage";
...
export default function CreateProjectPage() {
  ...
  /* Returns the create meta tagging form*/
  ...
  return (
    ...
    >
      {/* {handleCreateMetaTagging()} */}
      {!isCreateMetaTagging && !isBrowseMetaTagging && createProjectForm()}
      {isCreateMetaTagging && <MetaTagging onSave={savedMetaTagging} />}
