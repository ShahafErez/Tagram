...
class ChunkTests(TestCase):
    def test_role_means_ends_chunks(self):
        p = create_project()
        s = Story.create(
            text="As a User, I want to add a user story, so that I document a requirement", project_id=p.id)
...
class WellFormednessTests(TestCase):
    def test_well_formed(self):
        p = create_project()
        s = Story.create(
            text="As a User, I'm able to add a user story, so that I document a requirement", project_id=p.id)
        s.analyze()
    ...
    def test_no_means(self):
        p = create_project()
        story = Story.create(
            text="As a User, I add a user story, so that I document a requirement", project_id=p.id)
        p.analyze()
    ...
    def test_no_role(self):
        p = create_project()
        story = Story.create(
            text="User wants to add a user story, so that I document a requirement", project_id=p.id)
        p.analyze()
...
class AtomicTests(TestCase):
    def test_not_atomic(self):
        p = create_project()
        story = Story.create(
            text="As a User, I want to add a user story, so that I document a requirement and sell the system", project_id=p.id)
        p.analyze()
...
class MinimalTests(TestCase):
    def test_punctuation(self):
        p = create_project()
        story = Story.create(
            text="As a User, I want to add a user story, so that I document a requirement and sell the system. This is extra info", project_id=p.id)
        p.analyze()
    ...
    def test_brackets(self):
        p = create_project()
        story = Story.create(
            text="As a User, I want to add a user story, so that I document a requirement and sell the system (for money)", project_id=p.id)
        p.analyze()
...
class UniformTests(TestCase):
    def test_uniformity(self):
        ...
        Story.create(
            text="As a User, I want to add a user story, so that I document a requirement", project_id=p.id)
        Story.create(
            text="As a User, I want to add a user story, so that I document another requirement", project_id=p.id)
        story = Story.create(
            text="As a User, I am able to add a user story, so that I register a requirement", project_id=p.id)
        p.analyze()
...
def create_story(project_id):
    s = Story.create(
        text="As a User, I want to add a user story, so that I document a requirement", project_id=project_id)
    return s
